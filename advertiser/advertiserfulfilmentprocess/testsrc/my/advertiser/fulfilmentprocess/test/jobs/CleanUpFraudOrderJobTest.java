 ...
 */
package my.advertiser.fulfilmentprocess.test.jobs;
...
import my.advertiser.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AdvertiserFulfilmentProcessConstants.ORDER_PROCESS_NAME;
