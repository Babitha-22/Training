 ...
 */
package my.advertiser.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AdvertiserFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AdvertiserFulfilmentProcessConstants.PARENT_PROCESS);
