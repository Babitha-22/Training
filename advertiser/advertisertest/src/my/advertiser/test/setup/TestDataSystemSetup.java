 ...
 */
package my.advertiser.test.setup;
...
import my.advertiser.test.constants.AdvertiserTestConstants;
import my.advertiser.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AdvertiserTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/advertisertest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/advertisertest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/advertisertest/import/cstickets.impex");
			...
			importImpexFile(context, "/advertisertest/import/csquotes.impex");
		}
	}
}
