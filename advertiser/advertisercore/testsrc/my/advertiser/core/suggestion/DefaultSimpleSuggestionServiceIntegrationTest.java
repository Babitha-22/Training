 ...
 */
package my.advertiser.core.suggestion;
...
import my.advertiser.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/advertisercore/test/testSimpleSuggestionService.csv", "utf-8");
	}
