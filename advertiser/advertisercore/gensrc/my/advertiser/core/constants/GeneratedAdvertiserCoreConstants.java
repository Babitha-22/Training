 ...
 * ----------------------------------------------------------------
 */
package my.advertiser.core.constants;
...
public class GeneratedAdvertiserCoreConstants
{
	public static final String EXTENSIONNAME = "advertisercore";
	public static class TC
	{
		public static final String ADVERTISER = "Advertiser".intern();
	...
	public static class Attributes
	{
		...
		{
			public static final String ADVERTISERS = "advertisers".intern();
		}
	}
	...
	{
		public static final String ADVERTISER2PRODUCT = "Advertiser2Product".intern();
	}
	
	protected GeneratedAdvertiserCoreConstants()
	{
		// private constructor
	}
