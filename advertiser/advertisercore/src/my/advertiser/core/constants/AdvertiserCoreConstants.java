...
/**
 * Global class for all AdvertiserCore constants. You can add global constants for your extension into this class.
 */
public final class AdvertiserCoreConstants extends GeneratedAdvertiserCoreConstants
{
	public static final String EXTENSIONNAME = "advertisercore";


	private AdvertiserCoreConstants()
	{
		//empty
	}
