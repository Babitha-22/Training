...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/advertiserstorefront/electronics/en",
						"https://electronics.local:9002/advertiserstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/advertiserstorefront/electronics/en",
						"https://electronics.local:9002/advertiserstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/advertiserstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/advertiserstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/advertiserstorefront/electronics/en",
						"https://electronics.local:9002/advertiserstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/advertiserstorefront",
						"https://electronics.local:9002/advertiserstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/advertiserstorefront",
						"https://electronics.local:9002/advertiserstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/advertiserstorefront/electronics/en",
						"https://electronics.local:9002/advertiserstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
